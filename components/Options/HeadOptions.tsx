...
export const HeadOptions = () => {
    ...
    useEffect(()=>{
        dispatch({type: toggleHeadSize, payload: size && {height: size.slice(0, 3), width:size.slice(4, 7)}})
        dispatch({type: toggleHeadShape, payload: shape})
    }, [size, shape])
  return (
      <div className={styles.group}>      
        <div>
            ...
            <div className={styles.select}>
                <select className={styles.select_} value={shape} onChange={(e)=> {
