...
import { toggleBodyShape, toggleBodySize, toggleSkinColor } from "../../redux/slices/bodySlice"
...
export const BodyOptions = () => {
    ...
    useEffect(()=>{
        dispatch({type: toggleSkinColor, payload: color})
        dispatch({type: toggleBodySize, payload: size})
        dispatch({ type: toggleBodyShape, payload: shape })
    }, [size, color, shape])
  return (
      <>
        <div className={styles.group}>      
            <div>
                ...
                <div className={styles.select}>
                    <select className={styles.select_} value={color} onChange={(e)=> {
            ...
            <div>
                ...
                <div className={styles.select}>
                    <select className={styles.select_} value={size} onChange={(e)=> setSize(e.target.value)}>
        ...
        <div className = {styles.group}>
            <div>
                ...
                <div className={styles.select}>
                    <select className={styles.select_} value={shape} onChange={(e)=> setShape(e.target.value)}>
